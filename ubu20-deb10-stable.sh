...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Auther : ${green}  TUMBUNG VPN STORE ® ${NC}${YELLOW}(${NC} ${green} ANJAY POKONAMAH ${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/proj3c/user/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/proj3c/regip/main/ip"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/tumbungbakem/tumbungbakem/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
